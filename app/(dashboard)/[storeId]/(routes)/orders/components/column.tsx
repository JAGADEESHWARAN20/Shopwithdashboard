    ...
    cell: ({ row }) => (
      <Popover>
        ...
        <PopoverContent
          ...
          className="max-w-[90vw]  sm:mr-[60px] md:mr-[70px] lg:mr-[70px] md:max-w-[400px] h-auto max-h-[60vh] overflow-auto p-6 shadow-lg rounded-lg border border-gray-200 bg-white"
        >
