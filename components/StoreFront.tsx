...
interface StoreFrontProps {
    initialStore: {
        id: string;
        name: string;
        storeUrl?: string | null; // Allow undefined or null
...
const StoreFront: React.FC<StoreFrontProps> = ({ initialStore, initialBillboard, initialProducts }) => {
    ...
    }, [initialStore, store.id]); // Include initialStore and store.id
